    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-extrabold text-gray-900">Manage Wellness Programs</h1>
            <p className="text-gray-500 mt-2">Create, edit, and manage wellness programs</p>
          </div>
          <button
