  ...
  return (
    <div className="min-h-screen bg-gray-50 py-14">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-3">Health & Wellness Resources</h1>
          <p className="text-lg text-gray-500">Explore articles, guides, and information to support your well-being</p>
        </div>
