...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-primary-700 via-primary-600 to-secondary-600 text-white shadow-lg sticky top-0 z-50">
          ...
          <div className="md:hidden pb-4 pt-2 border-t border-white/20">
            <div className="flex flex-col gap-1 mt-2">
              ...
              {user ? (
                ...
                <Link
                  to="/login"
                  className="block mt-2 bg-white text-primary-700 px-4 py-2.5 rounded-lg text-sm font-semibold text-center hover:bg-primary-50 transition-colors duration-200"
                  onClick={() => setIsOpen(false)}
                >
                  Login
                </Link>
