...
export const ProgramCard = ({ program, onEnroll, isEnrolled }: ProgramCardProps) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 overflow-hidden group">
      <div className="w-full h-40 bg-gradient-to-br from-primary-50 via-primary-100 to-secondary-100 flex items-center justify-center">
        <Users size={44} className="text-primary-400 group-hover:scale-110 transition-transform duration-300" />
      </div>
